...
Además, se han utilizado técnicas de ampliación del \textit{dataset} original, a fin de contar con un mayor número de muestras de cada indivíduo y también, mejorar la robustez de las redes neuronales adaptadas.
