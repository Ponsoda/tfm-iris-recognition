...
\begin{abstract}
La utilización de la biometría para mejorar la seguridad de los aparatos electrónicos es un recurso ampliamente utilizado hoy en día.
El iris es uno de los elementos biométricos con los que cuenta el ser humano. Este trabajo compara la capacidad de reconocimiento de 
individuos que tienen las redes neuronales. Para ello, utilizando \textit{fine-tuning}, adaptaremos cuatro variaciones de nuestro dataset 
a la red VGG16. Estas variaciones son por la utilización de \textit{data augmentation}, tanto a imágenes del ojo sin pre-procesar como a 
imágenes del ojo donde se ha normalizado el iris.
