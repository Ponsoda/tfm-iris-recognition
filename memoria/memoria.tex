...
\author{\nombre}
\tutor{Dr. José Francisco Diez Pastor y Dr. Pedro Latorre Carmona}
\date{\today}
...
\begin{abstract}
Cada vez se utilizan más elementos biomédicos para poder identificar a las personas. En este trabajo vamos a utilizar técnicas de Inteligencia Artificial para
segmentar el iris y hacer una clasificación del mismo, optimizando procesos anteriores y haciendolos reproducibles.
\end{abstract}
