...
% En este artículo de Hadeel N Abdullah \cite{abdullah_iris_2015}, perteneciente a la University of Technology de Iraq, se lleva a cabo un pre-procesamiento de un conjunto de datos de imágenes oculares que incluye la extracción 
...
% artículo \cite{minaee_deepiris_2019}, se presenta la aplicación de técnicas de \textit{deep learning} para el reconocimiento del iris basado en una \textit{convolutional neural network} residual. Se utiliza la red pre-entrenada 
% de ResNet50\footnote{Red neuronal con 50 capas, entrenada para reconocer imágenes de entre mil categorías.} y técnicas de \textit{fine-tuning} con el conjunto de datos IIT Delhi\footnote{Accesible desde \url{https://www4.comp.polyu.edu.hk/~csajaykr/IITD/Database_Iris.htm}}. 
